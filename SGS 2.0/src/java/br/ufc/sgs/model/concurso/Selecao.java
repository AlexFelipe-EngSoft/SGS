...
public class Selecao {
    ...
    public Selecao(String titulo, String descricao, int vagasRemuneradas, int vagasVoluntarias) {
        setTitulo(titulo);
    ...
    public Selecao(int id_selecao, String titulo, String descricao, int vagasRemuneradas, int vagasVoluntarias) {
        this(titulo, descricao, vagasRemuneradas, vagasVoluntarias);
        this.id = id_selecao;
