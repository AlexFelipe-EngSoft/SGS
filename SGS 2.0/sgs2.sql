...
--
-- Host: 127.0.0.1
-- Generation Time: 02-Jun-2017 às 01:19
...
INSERT INTO `concurso` (`id`, `titulo`, `descricao`, `id_edital`, `preRequisitos`, `maisInformacoes`, `id_gerente`) VALUES
...
INSERT INTO `documentosrequisitados` (`id_selecao`, `descricao`) VALUES
...
INSERT INTO `selecao` (`id`, `titulo`, `descricao`, `vagasRemuneradas`, `vagasVoluntarias`, `id_concurso`) VALUES
(1, 'Programação Orientada a Objetos', 'Computação', 1, 2, 1);
